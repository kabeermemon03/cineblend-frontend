...
import { Mail, Lock, ArrowRight, AlertCircle, Eye, EyeOff, Chrome, Github, Facebook, CheckCircle2 } from 'lucide-react';
    ...
    <div className="min-h-screen flex bg-black relative overflow-hidden font-sans selection:bg-mocha/30 selection:text-white">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        <motion.div 
          ...
          className="absolute top-[-20%] right-[-10%] w-[800px] h-[800px] bg-mocha/5 blur-[150px] rounded-full" 
        />
        <motion.div 
          animate={{ 
            x: [0, -50, 0], 
          ...
          className="absolute bottom-[-20%] left-[-10%] w-[800px] h-[800px] bg-purple-dark/5 blur-[150px] rounded-full" 
        />
      </div>

      {/* Branding Panel */}
      <div className="hidden lg:flex lg:w-[45%] relative flex-col justify-center px-24 z-10 overflow-hidden border-r border-white/5 bg-[#050505]">
        <motion.div
        ...
        >
          <div className="space-y-6">
            ...
            <h2 className="text-7xl xl:text-8xl font-black text-white leading-[0.9] tracking-tighter italic">
              WELCOME <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-mocha via-mocha-light to-white/20">TO THE</span> <br />
              STUDIO.
            </h2>
          </div>

          <p className="text-white/30 text-xl max-w-sm font-medium leading-relaxed tracking-tight italic">
            "Your vision, our craft. The perfect blend of creativity and technology."
          </p>
      ...
      {/* Form Section */}
      <div className="w-full lg:w-[55%] flex items-center justify-center p-8 md:p-16 z-10 bg-black">
        <motion.div 
              ...
              {success ? (
                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-white/40 font-medium">Welcome back, creator.</p>
                  </div>
                </motion.div>
              ) : (
                <motion.div key="form" className="space-y-6">
                  <form onSubmit={handleLogin} className="space-y-6">
                    ...
                    <div className="space-y-5">
                      {/* Email Field with Floating Label Animation Effect */}
                      ...
                      <div className="space-y-2 group">
                        <div className="relative">
                          ...
                          <input
                            ...
                            className="peer w-full bg-white/5 border border-white/10 rounded-2xl py-4 pl-14 pr-14 text-white placeholder:text-transparent outline-none focus:border-mocha/40 focus:bg-white/[0.07] focus:ring-4 focus:ring-mocha/5 transition-all duration-300"
                            required
                          />
                          <label className="absolute left-14 top-1/2 -translate-y-1/2 text-white/20 text-sm font-medium transition-all duration-300 pointer-events-none peer-focus:top-0 peer-focus:text-[10px] peer-focus:font-black peer-focus:uppercase peer-focus:tracking-widest peer-focus:text-mocha peer-[:not(:placeholder-shown)]:top-0 peer-[:not(:placeholder-shown)]:text-[10px] peer-[:not(:placeholder-shown)]:font-black peer-[:not(:placeholder-shown)]:uppercase peer-[:not(:placeholder-shown)]:tracking-widest peer-[:not(:placeholder-shown)]:text-mocha bg-transparent px-1">
                            Password
                          </label>
                          <button
                            type="button"
